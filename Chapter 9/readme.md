...
Welcome to the first of four weeks in Unit 3 on D3, a powerful JavaScript library supporting coordination across many different kinds of map and visualization types. Week 8 includes three relatively longer lessons and ends with Activity 8 requiring you to compile a multivariate dataset for your Lab 2 D3 map.
...
We will demonstrate the utility of this distinction over the course of the Week 8 and 9 lessons. For now, let's start our script by using `d3.select()` to select the HTML `<body>` and D3's `.append()` method to add a new `<svg>` element, which eventually will hold our data-driven graphic. Make the selection in your _main.js_ file (Example 1.1).
...
![figure7.1.1.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.1.1.png)
...
![figure7.1.2.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.1.2.png)

###### Figure 1.2: An SVG created using D3

Note that both jQuery and D3 have `.append()` methods. In this case, we know that the `.append()` method we are using belongs to D3 because the block starts with `d3`. Recall from Week 6 how JavaScript object prototypes work: D3's `.append()` is a method of the `d3` object, just as jQuery's `.append()` is a method of the `jQuery` object (and its `$` alias). In any script that uses chain syntax or blocks (such as D3, Leaflet, and jQuery), the methods you can use in the chain depend on the library object referenced at the beginning of the chain (e.g., `d3`, `L`, or `$`). You can identify which library is being used by reading backwards up the chain or block to its beginning. If the beginning of the chain or block is a variable, you need to look at how that variable was created to discover which library is being used.
...
![figure7.1.4.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.1.4.png)
...
![figure7.1.5.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.1.5.png)
...
![figure7.1.6.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.1.6.png)
...
In Week 9, we will find that D3 allows us to map GeoJSON geometries by making use of the `"features"` array. For now, let's return to the basics.
...
![figure7.2.1.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.2.1.png)

###### Figure 2.1: The circles exist!

Notice there are five circles, one for each datum. Using `.append()` after a data join always creates the same number of new HTML elements as data values in the dataset. The circles are not visible on the page because, as you may recall from Week 6, they require `r`, `cx`, and `cy` attributes. We can use our joined data to position the circles (Example 2.6).
...
![figure7.2.2.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.2.2.png)

###### Figure 2.2: data-driven circles

### III. Complex Data

So far, we have relied upon a very simple array to build our example graphic. What if we want something a little more complex and meaningful—say, a graph of city populations. We can start with our more complicated data array from way back in Week 2 (Example 2.7).
...
![figure7.2.3.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.2.3.png)

###### Figure 2.3: A bubble chart of city populations

> ### **Using properly formatted D3 code blocks, create a bubble chart of the Week 2 example city data with circles named according to city name and sized according to city population.**
...
![figure7.3.1.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.1.png)
...
![figure7.3.2.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.2.png)
...
![figure7.3.3.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.3.png)
...
![figure7.3.4.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.4.png)
...
![figure7.3.5.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.5.png)
...
![figure7.3.6.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.6.png)
...
![figure7.3.7.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.7.png)
...
![figure7.3.8.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.8.png)
...
![figure7.3.9.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.9.png)
...
![figure7.3.10.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.10.png)
...
![figure7.3.11.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.11.png)
...
![figure7.3.12.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.12.png)
...
![figure7.3.13.png](https://raw.githubusercontent.com/uwcartlab/webcartography/master/Chapter%209/img/figure7.3.13.png)
